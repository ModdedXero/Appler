...
namespace Appler
{
	...
	void ImGuiLayer::OnAttach()
	{
		...
		ImGui_ImplGlfw_InitForOpenGL(Application::Get()->GetDisplay()->GetNativeWindow(), true);
	...
	{
		ImGuiIO& io = ImGui::GetIO();
		io.DisplaySize = ImVec2((float)Application::Get()->GetDisplay()->GetWidth(), (float)Application::Get()->GetDisplay()->GetHeight());
